...
import org.woonyong.lotto.core.domain.TicketNumber;
...
import org.woonyong.lotto.core.domain.WinningRank;
...
public class Ticket {
  ...
  public static Ticket createManual(
      final Long roundId, final LottoNumbers lottoNumbers, final String posUid) {
