...
public class BotService {
  ...
  private final int defaultPosCount;
  ...
  public BotService(
    ...
    this.defaultPosCount = centralServerConfig.getDefaultPosCount();
  }

  @Transactional
  public Bot createBot() {
    List<String> posUidList = createPosListForBot(defaultPosCount);
