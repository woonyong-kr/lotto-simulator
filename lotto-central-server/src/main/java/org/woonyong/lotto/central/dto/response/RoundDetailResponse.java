...
public record RoundDetailResponse(
    ...
    public static RoundDetailResponse of(
        ...
        long totalPrize = calculateTotalPrize(firstWinners, secondWinners, thirdWinners,
                fourthWinners, fifthWinners);
        ...
        return new RoundDetailResponse(
                ...
                firstWinners, secondWinners, thirdWinners,
                fourthWinners, fifthWinners,
                UNDETERMINED_PRIZE, UNDETERMINED_PRIZE, UNDETERMINED_PRIZE,
                totalPrize, remainingSeconds, endTimeFormatted
        );
    }

    private static long calculateTotalPrize(
            final long first, final long second, final long third,
            final long fourth, final long fifth
    ) {
        return first * 2000000000L + second * 50000000L + third * 1500000L
                + fourth * 50000L + fifth * 5000L;
    }
    ...
    private static String formatEndTime(final LocalDateTime endTime) {
        ...
        return String.format("%04d-%02d-%02d %02d:%02d 추첨",
