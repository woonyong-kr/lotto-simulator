...
public class CentralServerClient {
    ...
    private Long getCurrentRoundId() {
        ...
        if (response == null) {
            throw PosTerminalException.of(ERROR_CODE_CURRENT_ROUND_NOT_FOUND, ERROR_CURRENT_ROUND_NOT_FOUND);
        }
    ...
    public void reportStatistics(final String terminalId, final Long averageResponseTime) {
        ...
        try {
            ...
            throw PosTerminalException.of(ERROR_CODE_STATISTICS_REPORT_FAILED, ERROR_STATISTICS_REPORT_FAILED, e);
        }
    }

    private String extractTicketNumber(final ApiResponse response) {
        if (response == null) {
            throw PosTerminalException.of(ERROR_CODE_TICKET_PURCHASE_FAILED, ERROR_TICKET_PURCHASE_FAILED);
        }
