...
public class BotStatusReportScheduler {
  ...
  private Map<String, Object> createSinglePosStatus(
      final PosTerminalConnection connection, final int threshold) {
  ...
  private void logBotStatus(
      final String botUid, final boolean isActive, final String responseTime) {
    log.debug("Bot status reported: {} (Active: {}, Response: {})", botUid, isActive, responseTime);
  }
}
