...
public class TerminalController {
    ...
    public TerminalController(final TerminalPoolManager terminalPoolManager,
    ...
    public ResponseEntity<ApiResponse<RegisterTerminalResponse>> registerTerminal(
            @RequestBody final RegisterTerminalRequest request,
            final HttpServletRequest httpRequest) {

        // 요청 IP 주소 추출 (터미널 주소로 사용)
        ...
        RegisterTerminalResponse response = new RegisterTerminalResponse(
                true,
                terminalPoolManager.getAvailableCount()
        );
    ...
    public ResponseEntity<ApiResponse<AllocateTerminalResponse>> allocateTerminal(
        ...
        try {
            ...
            AllocateTerminalResponse response = new AllocateTerminalResponse(
    ...
    public ResponseEntity<ApiResponse<ReleaseTerminalResponse>> releaseTerminal(
        ...
        ReleaseTerminalResponse response = new ReleaseTerminalResponse(
                true,
                terminalPoolManager.getAvailableCount()
        );
